        ...
        if response.status_code == 200:
            ...
            return {
                ...
                "body": (
                    ...
                    if len(release_data["body"]) > 200
                    else release_data["body"]
                ),
            }
...
def main():
    ...
    print("=" * 60)
    print(
        f"   Application: {current_version} {'⚠️ UPDATE AVAILABLE' if latest_release and compare_versions(current_version, latest_release['version']) == -1 else '✅'}"
    )
