...
echo "🗄️ [2/6] Running database migration..."
python3 src/migrations/add_chat_improvements_v24.py
echo "✅ Migration completed"
echo ""

# 3. Deploy to GAE
echo "☁️ [3/6] Deploying to Google App Engine..."
...
# 5. Test Chat
echo "💬 [5/6] Testing chat endpoint..."
...
python3 -c "from src.utils.telegram_alert import send_telegram_alert; send_telegram_alert('Nowa wersja aplikacji NovaHouse Chatbot została wdrożona!')"
