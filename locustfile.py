...
class ChatbotUser(HttpUser):
    ...
    def send_message(self):
        ...
        self.client.post("/api/chatbot/message", json={
    ...
    def search_knowledge(self):
        ...
        self.client.get(f"/api/knowledge/search", params={
    ...
    def get_analytics(self):
        ...
        self.client.get("/api/analytics/summary", headers={
            "X-API-Key": "test-api-key"
        })
...
class AdminUser(HttpUser):
    ...
    def view_dashboard(self):
        ...
        self.client.get("/api/dashboard/widgets", headers={
            "X-API-Key": "test-api-key"
        })
    ...
    def view_leads(self):
        """Test leads listing"""
        self.client.get("/api/leads?page=1&per_page=20", headers={
            "X-API-Key": "test-api-key"
        })
    ...
    def view_analytics(self):
        ...
        self.client.get("/api/analytics/detailed", headers={
            "X-API-Key": "test-api-key"
        })
