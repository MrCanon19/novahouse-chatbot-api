...
COVERAGE_AREAS = {
    ...
    "description": (
        "Działamy na terenie trzech największych aglomeracji "
        "w Polsce"
    ),
}
...
PRODUCT_CATALOGS = {
    "catalog_1": {
        ...
        "description": (
            "Podstawowy katalog z sprawdzonymi produktami "
            "dostępnymi od ręki"
        ),
    },
    "catalog_2": {
        ...
        "availability": "od ręki",
        "description": (
            "Rozszerzony katalog z większym wyborem kolorów, "
            "materiałów i personalizacji"
        ),
    },
    "catalog_3": {
        ...
        "description": (
            "Najwyższej jakości produkty, nowoczesne kolekcje, "
            "światowe marki"
        ),
    },
}
...
PACKAGES = {
    "express": {
        ...
        "ideal_for": (
            "Inwestorzy i osoby szukające szybkich, "
    ...
    "express_plus": {
        ...
        "doors": (
            "skrzydła drzwiowe przylgowe lub bezprzylgowe, "
            "ościeżnice, klamki"
        ),
        "walls": "malowanie ścian na wybrany kolor",
        "lighting": "Dobór oświetlenia",
        "ideal_for": (
            "Rodziny i osoby, które chcą mieć wpływ na wygląd "
            "swojego wnętrza"
        ),
        "personalization_before_contract": "nie",
        "visualization": "nie",
    ...
    "comfort": {
        ...
        "doors": (
            "skrzydła drzwiowe bezprzylgowe lub ukryte, "
            "ościeżnice, klamki"
        ),
        "walls": "malowanie ścian na wybrany kolor",
        "lighting": "Dobór oświetlenia",
        "ideal_for": (
            "Osoby wymagające, szukające wyjątkowego designu "
            "i indywidualnego podejścia"
        ),
    ...
    "premium": {
        ...
        "doors": (
            "skrzydła drzwiowe bezprzylgowe lub ukryte "
            "lub przesuwane lub drewniane"
        ),
        "walls": "malowanie ścian na wybrany kolor",
        "lighting": "Dobór oświetlenia",
        "ideal_for": (
            "Najbardziej wymagający klienci szukający prestiżowego, "
    ...
    "individual": {
        ...
        "description": (
            "Pełna personalizacja 1:1, najwyższa jakość "
            "bez kompromisów"
        ),
        "features": [
            ...
            (
                "Indywidualny dobór materiałów - bez ograniczeń "
                "katalogowych, z całego rynku"
            ),
        ...
        "ideal_for": (
            "Klienci szukający całkowicie unikalnego wnętrza "
...
FAQ = {
    # Czas realizacji
    "jak_dlugo_trwa_calosc": (
        "W przypadku pakietów Express i Express Plus: zazwyczaj "
        "od 7 do 10 tygodni – w zależności od pakietu, zakresu "
        "i metrażu. W przypadku pakietów Comfort i Premium: zazwyczaj "
        "od 12 do 18 tygodni – w zależności od pakietu, zakresu "
        "i metrażu. W przypadku projektu indywidualnego: zazwyczaj "
        "od 14 do 20 tygodni – w zależności od zakresu i metrażu. "
        "Projekt + realizacja to całość, którą prowadzimy od A do Z."
    ),
    "kiedy_rozpoczecie_projektowanie": (
        "Najczęściej w ciągu 1–2 tygodni od podpisania umowy – w tym czasie "
        "finalizujemy umowę i dobieramy odpowiedniego projektanta do Twoich potrzeb."
    ), 
    "jak_dlugo_trwa_projektowanie": (
        "Standardowo: pakiet Express 1–2 tygodnie. Wyższe pakiety Comfort i Premium "
        "to 4-6 tygodni. Przy projektach indywidualnych może być dłużej 6-10 tygodni "
        "w zależności od metrażu, bo wszystko dopasowujemy pod Ciebie."
    ), 
    "ile_trwa_wykończenie": (
        "W pakietach bazowych Express i Express Plus wykończenie trwa 6–8 tygodni. "
        "Przy większych metrażach lub nietypowych rozwiązaniach czas może się "
        "wydłużyć."
    ), 
    "kiedy_rozpoczecie_realizacje": (
        "Najczęściej w ciągu 1–2 tygodni od zakończenia projektu – w tym czasie "
        "finalizujemy projekt, kosztorys i zamawiamy materiały."
    ), 
    # Proces
    "czy_musze_byc_obecny": (
        "Nie 🙂. Nasz zespół prowadzi całość, a Ty dostajesz regularne raporty i "
        "zdjęcia. Możesz być w stałym kontakcie z Koordynatorem projektu."
    ), 
    "pomoc_z_odbiorem_dewelopera": (
        "Tak, pomagamy w odbiorze technicznym i doradzamy przy zgłoszeniach – Nasz "
        "inżynier sprawdza mieszkanie i przedstawia raport z ewentualnymi usterkami."
    ), 
    "proces_krok_po_kroku": (
        "1. Rozmowa telefoniczna o preferencjach → 2. Spotkanie ze specjalistą ds "
        "wykończeń wnętrz → 3. Opcjonalne 2 spotkanie z projektantem → 4. Podpisanie "
        "umowy → 5. Projektowanie → 6. Zakupy i logistyka → 7. Realizacja "
        "wykończenia i nadzór → 8. Montaż zabudów stolarskich → 9. Odbiór i "
        "gwarancja."
    ), 
    "wspolpraca_zdalna": (
        "Tak. Realizujemy projekty w – Gdańsk, Warszawa, Wrocław oraz okolice do 60 "
        "km od Centrum. Dojeżdżamy i prowadzimy zdalne konsultacje."
    ), 
    # Pakiety - zakres i różnice
    "co_zawiera_pakiet": (
        "Wspólny zakres dla wszystkich pakietów: Odbiór lokalu od dewelopera przez "
        "inspektora budowlanego, kompleksowe prace wykonawcze (malowanie, montaż "
        "podłóg, drzwi, pełne wykończenie łazienki: płytki, armatura, "
        "prysznic/wanna, WC, lustro, oświetlenie), materiały budowlane (kleje, "
        "farby, fugi, hydroizolacja), materiały wykończeniowe (podłogi, listwy, "
        "płytki, drzwi, klamki, armatura, ceramika), koordynacja zamówień materiałów "
        "i prac, sprzątanie pobudowlane, projekt pakietowy (układ funkcjonalny, "
        "rzuty wykonawcze, moodboardy, lista zakupowa, konsultacje z projektantem). "
        "Wyższe pakiety Comfort i Premium posiadają dodatkowo wizualizacje wybranych "
        "pomieszczeń."
    ), 
    "roznice_miedzy_pakietami": (
        "Kluczowe różnice: 1) Standard produktów (Basic, Standard, Comfort, "
        "Premium, Indywidualny), 2) Liczba produktów do wyboru (od 150 do pełnego "
        "asortymentu 7 sklepów partnerskich), 3) Zakres wizualizacji (od "
        "podstawowych do pełnych wizualizacji całego mieszkania), 4) Liczba "
        "konsultacji z projektantem (od 1 do 5 spotkań), 5) Zakres wykończenia "
        "łazienki (wysokość płytek, wielkość płytek, ilość oświetlenia, typy baterii "
        "itp.), 6) Rodzaj podłóg (od laminatów, przez winylowe do drewnianych), 7) "
        "Rodzaj drzwi (od przylgowych przez bezprzylgowe do ukrytych), 8) Czas "
        "realizacji (od 6 do 16 tygodni)."
    ), 
    "projekt_indywidualny_vs_pakiet": (
        "Projekt indywidualny to pełna personalizacja 1:1, dobór produktów z całego "
        "rynku, materiały w dowolnym przedziale cenowym po premium, wizualizacje "
        "całego mieszkania, wydłużony czas prac projektanta na konsultacje, brak "
        "ograniczeń katalogowych. Cena: 1700–5000 zł/m² + zabudowy stolarskie. W "
        "skrócie: Pakiety = szybciej i taniej. Projekt Indywidualny = najwyższa "
        "personalizacja i architekt tylko dla Ciebie."
    ), 
    "zmiana_elementow_pakietu": (
        "Tak. W pliku masz jasno określone limity zmian: Express: 2 zmiany "
        "produktów, Express Plus: 3 zmiany, Comfort/Szafran: 5 zmian, "
        "Premium/Pomarańczowy/Cynamonowy: 7 zmian. Wszystkie zmiany rozliczane są "
        "różnicą cenową danego produktu."
    ), 
    "laczenie_pakietow": (
        "Tak. Każdy pakiet ma określony limit zmian między katalogami (2–7 zmian). "
        "Plus: dopłata za różnice cenowe oraz możliwość wyboru produktów z poza "
        "katalogu z 7 sklepów partnerskich."
    ), 
    # Ceny i rozliczenia
    "jak_liczycie_metry": (
        "Metraż rozliczamy zawsze uczciwie i transparentnie — po powierzchni "
        "podłogi, bo tylko ona realnie wpływa na zakres prac i koszt materiałów. "
        "Klient od początku zna dokładny koszt, bez ukrytych dopłat."
    ), 
    "cena_pakietu_meble_oswietlenie": (
        "Oświetlenie – nie (tylko dobór oświetlenia na bazie 12 popularnych "
        "producentów), Meble – NIE (podstawowe szafki łazienkowe w pakietach Express "
        "i Express Plus), Gładzenie ścian – nie ma tego w zakresie prac, jest tylko "
        "gruntowanie + malowanie (w pakietach nie ma gładzi). Jeśli klient "
        "potrzebuje gładzi lub mebli, czy oświetlenia – możemy to zrealizować jako "
        "prace dodatkowe."
    ), 
    "kuchnie_szafy": (
        "Tak – oferujemy kuchnie na wymiar i szafy wnękowe realizowane przez "
        "naszych sprawdzonych stolarzy. Projektujemy, koordynujemy i montujemy "
        "zabudowy tak, aby pasowały do całego wnętrza."
    ), 
    "koszt_dla_metrazu": (
        "Ceny naszych pakietów startują już od 999 zł/m² w wersji Express. Pakiet "
        "Express Plus to od 1199 zł/m², Comfort zaczyna się od 1499 zł/m², a Premium "
        "– od 1999 zł/m². Aby przygotować precyzyjną wycenę dla Twojego mieszkania, "
        "potrzebujemy krótkiego spotkania lub przesłania rzutu lokalu — wtedy "
        "przeliczamy ofertę co do metra."
    ), 
    "koszt_projekt_indywidualny": (
        "Projekt Indywidualny to w pełni spersonalizowana usługa, w której "
        "architekt pracuje z Tobą 1:1 i tworzy wnętrze dokładnie pod Twój styl, "
        "potrzeby i budżet. Cena: 1700–5000 zł/m² (w zależności od standardu i "
        "złożoności). W ramach projektu otrzymujesz: kompletny układ funkcjonalny, "
        "pełną dokumentację wykonawczą, pełne wizualizacje 3D (łazienka, salon z "
        "kuchnią, hol, sypialnie), indywidualny dobór materiałów z całego rynku, "
        "listy zakupowe, stały kontakt z architektem, możliwość wyboru materiałów "
        "premium z Polski i Europy."
    ), 
    "dodatkowe_oplaty": (
        "Tak: dopłaty za zmiany produktów (różnica cenowa), prace dodatkowe poza "
        "zakresem katalogu (gładzie, przeróbki hydrauliczne, elektryczne, zabudowy "
        "GK, meble na wymiar). Wszystko pokazujemy z góry i podpisujemy przed "
        "pracami, żeby klient nie miał żadnych niespodzianek na podstawie cennika."
    ), 
    "vat": (
        "Wykończenia mieszkań do 150 m² = 8% VAT. Wykończenia domów do 300 m² = 8% "
        "VAT. Wszystkie nasze pakiety mają już wliczony korzystny VAT 8% – klient od "
        "razu wie, ile płaci."
    ), 
    "kosztorys": (
        "Tak – przygotowujemy dokładną specyfikację prac oraz materiałów dla "
        "konkretnego mieszkania. Nic nie jest ukryte."
    ), 
    "platnosc_transze": (
        "Tak – umożliwiamy wygodny system rozliczeń w kilku transzach."
    ), 
    "dodatkowe_prace_rozliczenie": (
        "Każde dodatkowe prace wyceniamy na podstawie naszego cennika pisemnie "
        "przed wykonaniem. Zero niespodzianek i pełna kontrola kosztów."
    ), 
    # Katalogi i rabaty
    "ile_katalogow": (
        "Mamy 3 katalogi produktów: Katalog 1 (Basic) - 150 produktów dla pakietu "
        "Express, Katalog 2 (Standard) - 300 produktów dla pakietu Express Plus, "
        "Katalog 3 (Premium) - 450 produktów dla pakietów Comfort i Premium. "
        "Produkty w katalogach Basic i Standard są dostępne od ręki, produkty "
        "Premium na zamówienie."
    ), 
    "rabat_na_materialy": (
        "Tak! Wszyscy klienci otrzymują rabat 15% na wszystkie materiały. To jeden "
        "z benefitów współpracy z NovaHouse - dzięki naszym negocjacjom z dostawcami "
        "możesz zaoszczędzić na materiałach wysokiej jakości."
    ), 
    "wymiana_produktow_miedzy_katalogami": (
        "Tak, możesz wymieniać produkty między katalogami w ramach limitów: Express "
        "- 2 produkty, Express Plus - 3 produkty, Comfort - 5 produktów, Premium - 7 "
        "produktów. Przy wymianie obowiązuje rozliczenie różnicy cenowej. Dodatkowo "
        "możesz wybierać produkty z poza katalogu ze sklepów partnerskich (Express "
        "Plus: 1 produkt, Comfort: 3 produkty, Premium: 5 produktów) z dopłatą "
        "wynikającą z różnicy ceny."
    ), 
    # Pozostałe
    "gwarancja": (
        "Udzielamy 36-miesięcznej (3-letniej) gwarancji od momentu odbioru na "
        "wykonane prace. To jeden z najdłuższych okresów gwarancji na rynku! Na "
        "materiały obowiązuje gwarancja producenta."
    ), 
    "produkty": (
        "Współpracujemy z najlepszymi producentami: Laufen, Geberit, Kaldewei, "
        "Hansgrohe, Grohe, Roca, Tubadzin, Paradyż, Mapei, Quick-Step, Deante, "
        "Ferro, Cersanit i wiele innych. W zależności od pakietu oferujemy różne "
        "opcje — od standardowych do luksusowych marek."
    ), 
    "terminowosc": (
        "Terminowość to nasz standard i obietnica! Każdy etap prac realizujemy "
        "zgodnie z ustalonym harmonogramem. 94% naszych zleceń oddajemy przed "
        "terminem. Dzięki sprawdzonemu systemowi zarządzania projektami masz pewność "
        "realizacji na czas."
    ), 
    "ekipy": (
        "Współpracujemy wyłącznie ze sprawdzonymi ekipami wykończeniowymi, które "
        "znamy od lat i z którymi zrealizowaliśmy dziesiątki udanych projektów. To "
        "fachowcy, którym ufamy - rzetelni, terminowi i dbający o detale."
    ), 
    "gdzie_dzialamy": (
        "Działamy na terenie Trójmiasta (Gdańsk, Sopot, Gdynia), Warszawy oraz "
        "Wrocławia oraz okolice do 60 km od Centrum. Nasze biura znajdują się: "
        "Gdańsk - ul. Pałubickiego 2 (C2-parter), Warszawa - ul. Prosta 70 (5 "
        "piętro), Wrocław - ul. Sucha 3."
    ), 
    "po_odbiorze": (
        "Po zakończeniu prac Twoje mieszkanie będzie idealnie czyste i gotowe do "
        "natychmiastowego zamieszkania. Dodatkowo zapewniamy 36-miesięczną gwarancję "
        "od momentu odbioru."
    ), 
    # Domy pasywne
    "domy_pasywne": (
        "Oferujemy budowę domów pasywnych w trzech podstawowych metrażach: 70m² "
        "(idealny dla pary), 85m² (dla małej rodziny) i 140m² (dla większej "
        "rodziny). Nasze domy wykorzystują nowoczesne technologie: Posytec (system "
        "izolacji), IsoBeton (energooszczędny materiał konstrukcyjny) i CLT/HBE "
        "(połączenie drewna i betonu). Domy pasywne charakteryzują się minimalnym "
        "zużyciem energii, niskimi kosztami eksploatacji i doskonałą wentylacją z "
        "odzyskiem ciepła."
    ), 
    "technologie_domy_pasywne": (
        "W naszych domach pasywnych wykorzystujemy trzy główne technologie: 1) "
        "Posytec - zaawansowany system izolacji zapewniający doskonałą izolację "
        "termiczną, 2) IsoBeton - energooszczędny materiał konstrukcyjny o wysokich "
        "parametrach izolacyjnych, 3) CLT/HBE (Cross Laminated Timber / Holz Beton "
        "Element) - połączenie drewna i betonu zapewniające doskonałe właściwości "
        "izolacyjne i konstrukcyjne."
    ), 
    # Zabudowy stolarskie
    "zabudowy_stolarskie_szczegoly": (
        "Oferujemy kompleksowe zabudowy stolarskie na wymiar: szafy, garderoby, "
        "dressing roomy, biblioteczki, regały, zabudowy kuchenne i łazienkowe. "
        "Proces obejmuje kompleksowe podejście od projektu, przez produkcję, aż po "
        "montaż. Korzystamy z najwyższej jakości materiałów dla trwałości i "
        "funkcjonalności. Wycena jest przygotowywana indywidualnie po zrobieniu "
        "projektu."
    ), 
    "kuchnie_na_wymiar": (
        "Tak, wykonujemy kuchnie na wymiar. Wycena jest przygotowywana "
        "indywidualnie po zrobieniu projektu, uwzględniającego wszystkie Twoje "
        "potrzeby i preferencje. Oferujemy kompleksowe zabudowy kuchenne dopasowane "
        "do przestrzeni."
    ), 
    # Usługi dodatkowe
    "klimatyzacja": (
        "Tak, oferujemy montaż klimatyzacji. W pakiecie Waniliowy/Express cena za "
        "jedną jednostkę zaczyna się od 7800 zł. W pozostałych pakietach wycena jest "
        "przygotowywana indywidualnie po zrobieniu projektu."
    ), 
    "schody_na_zamowienie": (
        "Tak, wykonujemy schody na zamówienie. Wycena jest przygotowywana "
        "indywidualnie po zrobieniu projektu, uwzględniającego wszystkie potrzeby i "
        "preferencje."
    ), 
    "wizualizacje": (
        "Oferujemy wizualizacje 3D projektowanych wnętrz, które pozwalają zobaczyć, "
        "jak będzie wyglądać gotowa przestrzeń przed rozpoczęciem prac. Wizualizacje "
        "są dostępne w pakietach Comfort (łazienka, kuchnia), Premium (łazienka, "
        "salon, kuchnia, hol) oraz w projektach indywidualnych (całe mieszkanie)."
    ), 
    "nadzor_prace": (
        "Tak, zapewniamy pełen nadzór nad pracami. Nasi Projektanci nadzorują każdy "
        "etap realizacji – dbają o zgodność z projektem, normy techniczne oraz "
        "terminowe dostawy materiałów. Dzięki temu nie musisz martwić się przepisami "
        "budowlanymi ani technicznymi szczegółami."
    ), 
    "raporty_postep": (
        "Tak, regularnie przesyłamy raporty dotyczące postępu prac, w tym zdjęcia. "
        "Dzięki temu możesz na bieżąco śledzić postępy bez konieczności wychodzenia "
        "z domu."
    ), 
    # Informacje firmowe
    "dane_firmowe": (
        "NovaHouse Sp. z o.o. jest zarejestrowana pod numerem KRS 0000612864, "
        "posiada NIP 5833201699 oraz REGON 364323586. Kapitał zakładowy firmy wynosi "
        "100.000,00 PLN. Działamy od 2011 roku."
    ), 
    "kontakt_specjalistyczny": (
        "W sprawach logistyki i zamówień można dzwonić pod numer +48 509 929 437, w "
        "kwestiach finansowych i księgowych pod numer +48 607 518 544. W sprawie "
        "współpracy z partnerami i wykonawcami: partnerzy@novahouse.pl. Główny "
        "kontakt: +48 585 004 663, kontakt@novahouse.pl."
    ), 
    "doswiadczenie_firmy": (
        "NovaHouse działa na rynku od 2011 roku. Mamy za sobą ponad 350 "
        "zrealizowanych projektów i 96% zadowolonych klientów. Współpracujemy z "
        "ponad 120 sprawdzonymi dostawcami i wykonawcami. 94% naszych projektów "
        "oddajemy przed terminem."
    ), 
}
...
QUALIFICATION_QUESTIONS = [
    ...
    },
    {
        "id": 8,
    "question": (
        "Czy jesteś zainteresowany konsultacją z naszym designerem?"
    ), 
        "type": "boolean",
        "weight": 5,
        "scoring": {
...
PROCESS_STEPS = {
    ...
    "description": (
        "Oferujemy cztery różnorodne pakiety wykończeniowe lub możliwość stworzenia "
        "projektu dostosowanego do Twoich potrzeb. Po otrzymaniu informacji o "
        "metrażu skontaktujemy się, aby umówić się na spotkanie, na którym "
        "przygotujemy szczegółową wycenę zgodnie z Twoimi preferencjami i "
        "wymaganiami."
    ), 
    ...
    "description": (
        "Spotkanie aranżacyjne dopasujemy do Twojej wygody – może odbyć się zdalnie "
        "lub w naszym biurze. Każdy z naszych pakietów oraz elementy kosztorysu są w "
        "pełni elastyczne, co daje Ci swobodę modyfikacji zgodnie z Twoimi "
        "potrzebami. Przygotujemy dla Ciebie 2-3 propozycje układów funkcjonalnych "
        "do wyboru, na podstawie których stworzymy precyzyjną listę zakupów oraz "
        "projekt wykonawczy."
    ), 
    ...
    "description": (
        "Z naszą usługą wykończeniową i nadzorem możesz cieszyć się spokojem i "
        "zająć się swoimi sprawami – Projektant zajmie się wszystkim za Ciebie! Od "
        "zarządzania całym przebiegiem prac, przez organizację zamówień i montaż "
        "zabudów stolarskich, aż po finalną kontrolę jakości. Dzięki temu masz "
        "pewność, że efekt końcowy będzie zgodny z Twoimi oczekiwaniami."
    ), 
    ...
    "description": (
        "Po zakończeniu prac Twoje mieszkanie będzie idealnie czyste i gotowe do "
        "natychmiastowego zamieszkania. Dodatkowo, zapewniamy Ci 36-miesięczną "
        "gwarancję od momentu odbioru, co daje Ci pełen komfort i poczucie "
        "bezpieczeństwa."
    ), 
        "duration": "1 dzień",
        "deliverables": [
...
PORTFOLIO = {
    ...
    "url": (
        "https://novahouse.pl/realizacje/mieszkanie-100-m2-projekt-indywidualny/"
    ), 
    },
    "realizacja_2": {
...
BLOG_ARTICLES = [
    {
    "title": (
        "Architekt Wnętrz – Kim Jest i Dlaczego Warto Zatrudnić Profesjonalistę?"
    ), 
    "url": (
        "https://novahouse.pl/architekt-wnetrz-kim-jest-i-dlaczego-warto-zatrudnic-profesjonaliste/"
    ), 
    },
    {
        "title": "Kuchnia modułowa czy na wymiar? Kompleksowy przewodnik",
    "url": (
        "https://novahouse.pl/kuchnia-modulowa-czy-na-wymiar-kompleksowy-przewodnik-dla-osob-urzadzajacych-wymarzona-kuchnie/"
    ), 
    },
    {
        "title": "Aranżacja wnętrz z NovaHouse – Twój styl w każdym detalu",
    "url": (
        "https://novahouse.pl/aranzacja-wnetrz-z-novahouse-twoj-styl-w-kazdym-detalu/"
    ), 
    },
    {
    "title": (
        "Gotowe mieszkania z NovaHouse – oszczędź czas i zamieszkaj od zaraz"
    ), 
    "url": (
        "https://novahouse.pl/gotowe-mieszkania-nowoczesne-rozwiazania-dla-twojego-komfortu/"
    ), 
    },
    {
        "title": "Planowanie Remontu Domu – Kluczowe Kwestie do Rozważenia",
    "url": (
        "https://novahouse.pl/planowanie-remontu-domu-kluczowe-kwestie-do-rozwazenia/"
    ), 
    },
    {
...
TEAM_INFO = {
    "wiceprezes": {
        ...
        "position": "Wiceprezes",
    "quote": (
        "Wiem, jak wiele decyzji trzeba podjąć podczas urządzania mieszkania – "
        "dlatego postanowiliśmy ułatwić Ci ten proces. Przygotowaliśmy dla Ciebie "
        "starannie wyselekcjonowane katalogi produktów. To nie jest przypadkowy "
        "zbiór – to efekt wieloletniej współpracy z naszymi klientami."
    ), 
    ...
    "role": (
        "Projektowanie wnętrz, dobór materiałów, koordynacja z klientem"
    ), 
...
CLIENT_REVIEWS = [
    ...
    "text": (
        "Skorzystałem z usługi wykończenia pod klucz. Kontakt jest z jedną osobą, "
        "wyznaczoną projektantką, która projektuje i koordynuje prace. Mieszkanie "
        "było..."
    ), 
    },
    {
        ...
        "time": "4 tygodnie temu",
    "text": (
        "Wiele czynników sprawiło że zdecydowaliśmy się na Novahouse. Wywiązali się "
        "wzorowo z umowy. Jakość zabudowy stolarskiej bardzo dobra, gładzie i..."
    ), 
    },
    {
        ...
        "time": "4 tygodnie temu",
    "text": (
        "Wykonywaliśmy wykończenie mieszkania wraz z NovaHouse. Otrzymaliśmy sporo "
        "praktycznych rozwiązań już na etapie projektowania. Z odrobiną cierpliwości "
        "i współpracy udało..."
    ), 
    },
    {
        ...
        "time": "tydzień temu",
    "text": (
        "Jestem zadowolona z projektów zaproponowanych przez projektanta pana "
        "Michała. Wykazał się profesjonalizmem i, co bardzo ważne, cierpliwością "
        "przy ustalaniu różnych..."
    ), 
    },
    {
        "author": "Beata Werner",
    ...
    "text": (
        "Firma NovaHouse bardzo dobrze zaprojektowała moje nowe mieszkanie, "
        "wszystkie meble a także pomogła stworzyć w moim domu styl prowansalski. "
        "Bardzo..."
    ), 
    },
]
...
WHY_CHOOSE_US = {
    "kompleksowo": (
        "Kompleksowo – od projektu, przez produkcję, aż po montaż. Nie musisz "
        "koordynować pracy różnych ekip – wszystko załatwiamy za Ciebie."
    ), 
    "gwarancja": (
        "Gwarancja jakości i trwałości: Korzystamy z najwyższej jakości materiałów, "
        "dzięki czemu nasze zabudowy są funkcjonalne i trwałe przez lata."
    ), 
    "budzet": (
        "Pełna kontrola nad budżetem: Oferujemy przejrzyste wyceny, dostosowane do "
        "budżetu, który planujesz przeznaczyć. Dzięki temu dokładnie wiesz, za co "
        "płacisz."
    ), 
    "terminowosc": (
        "94% projektów oddanych przed terminem - to nasza obietnica i standard "
        "pracy."
    ), 
    "ekipy": (
        "Sprawdzone ekipy wykończeniowe znane od lat - rzetelne, terminowe, dbające "
        "o każdy detal."
    ), 
    "raporty": (
        "Raporty i zdjęcia na bieżąco - pełna kontrola bez wychodzenia z domu."
    ), 
    "sprzatanie": (
        "Mieszkanie gotowe do zamieszkania - idealna czystość po zakończeniu prac."
    ), 
}
...
PACKAGE_BENEFITS = {
    "title": (
        "Nasze pakiety wykończeniowe – szybciej, prościej, przewidywalnie"
    ), 
    "benefits": [
...
PASSIVE_HOUSES = {
    "description": (
        "Domy pasywne to energooszczędne budynki, które minimalizują zużycie "
        "energii dzięki doskonałej izolacji i wykorzystaniu odnawialnych źródeł "
        "energii."
    ), 
    "available_sizes": {
        "70m2": {
    ...
    "technologies": {
        "posytec": {
            "name": "Posytec",
    "description": (
        "Zaawansowany system izolacji zapewniający doskonałą izolację termiczną"
    ), 
        },
        "isobeton": {
            "name": "IsoBeton",
    "description": (
        "Energooszczędny materiał konstrukcyjny o wysokich parametrach izolacyjnych"
    ), 
        },
        "clt_hbe": {
            "name": "CLT/HBE",
    "description": (
        "Cross Laminated Timber / Holz Beton Element - połączenie drewna i betonu "
        "zapewniające doskonałe właściwości izolacyjne i konstrukcyjne"
    ), 
        },
    },
    "benefits": [
...
CARPENTRY_SERVICES = {
    "description": (
        "Tworzymy zabudowy stolarskie na wymiar - kompleksowo od projektu przez "
        "produkcję do montażu. Korzystamy z najwyższej jakości materiałów dla "
...
ADDITIONAL_SERVICES = {
    ...
    "description": (
        "Wizualizacje projektowanych wnętrz pozwalające zobaczyć gotową przestrzeń "
    ...
    "description": (
        "Projektanci nadzorują każdy etap realizacji – dbają o zgodność z "
        "projektem, normy techniczne oraz terminowe dostawy materiałów"
    ), 
    },
    "raporty": {
        "name": "Raporty z postępu prac",
    "description": (
        "Regularne przesyłanie raportów i zdjęć z postępu prac"
    ), 
    },
}
...
BLOG_TOPICS = {
    ...
    "description": (
        "Edukacja w zakresie projektowania i wykańczania wnętrz, praktyczne porady, "
        "inspiracje"
    ), 
    "categories": [
