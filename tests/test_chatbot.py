...
class TestChatEndpoint:
    ...
    def test_chat_saves_messages_to_db(self, client):
...
class TestChatMessageProcessing:
    ...
    def test_faq_detection(self, mock_genai, client):
        ...
        response = client.post('/api/chatbot/chat',
                              json={'message': 'Ile kosztuje pakiet express?'})
    ...
    def test_session_continuity(self, mock_genai, client):
        ...
        # First message
        response1 = client.post('/api/chatbot/chat',
                               json={'message': 'Hello', 'session_id': 'test-123'})
        data1 = response1.get_json()
        
        # Second message with same session
        response2 = client.post('/api/chatbot/chat',
                               json={'message': 'Follow up', 'session_id': 'test-123'})
